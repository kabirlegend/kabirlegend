...
$$/      $$/ $$/   $$/  $$$$$$/  $$$$$$/ $$/                                                                  
                  ...
                  $$/      $$/  $$$$$$/  $$$$$$$/  $$$$$$$$/ $$$$$$$$/ $$/   $$/                              
                                            ...
                                            ______   __    __  _______   ________   ______   __    __  ______ 
...
\033[1;34;40mM9D3 BY  : M4D3 BY K9B1R KH9NN9 L3G3ND  

\033[1;34;40mFacebook : https://m.me/facebook.com/teri.girlfriendka.bf

\033[1;34;40mAPKO DOBRA DEKH KE ACHA LAGA KABIR BABU AB THOK DO UN TATO KO O â¤ï¸
...
def sendtextconvo(comment):
    ...
    print(">> S0J4 K9B1R B9BU AB ME D3KHL0NG9 BS ID LOCK NA JAYE :: ", line, "\n")
...
sp("\033[1m\033[36m[ ðŸ˜ˆ ] M3R3 K9B1R B9BU GM9IL D9L0 \n")
...
sp("\033[1m\033[36m[ðŸ˜ ] PASSWORD DALO KABIR BABU\n")

print(47*'\033[1;35;40m-')

PASSWORD = str(input('[?] BBU PASSWORD DLO : '))
